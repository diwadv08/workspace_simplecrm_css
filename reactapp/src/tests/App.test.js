...
describe('Book Review & Rating Platform - Tests', () => {
  ...
  test('creates new book and updates list', async () => {
    render(<App />);
  ...
  test('book form input updates state', () => {
    render(<App />);
  ...
  test('does not call addBook if form is empty', () => {
    render(<App />);
    fireEvent.click(screen.getByRole('button', { name: /Add Book/i }));
  ...
  test('clears form after adding book', async () => {
    render(<App />);
  ...
  test('renders No reviews yet when no averageRating', async () => {
  ...
  test('does not call addReview if form empty', async () => {
    render(<App />);
 ...
 // 12 ✅ Works when book list is empty
  test('renders empty book list correctly', async () => {
  ...
  test('rating input accepts numbers', async () => {
    render(<App />);
