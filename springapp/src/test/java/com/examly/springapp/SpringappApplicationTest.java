...
public class SpringappApplicationTest {
    ...
    // 1 ✅ Context loads
    @Test
    public void loadContextAndBeansProperly() {
    ...
    @Test
    public void repositoryLayerBookSaveAndFind() {
        Book book = new Book();
    ...
    // 3 ✅ Service save & find
    @Test
    public void serviceLayerSaveBook() {
        Book book = new Book();
    ...
    @Test
    public void getAllBooksEndpoint() throws Exception {
    ...
    @Test
    public void postNewBookEndpoint() throws Exception {
        Book book = new Book();
    ...
    @Test
    public void repositoryAndServiceSaveReview() {
    ...
    @Test
    public void getReviewsByBookIdEndpoint() throws Exception {
        Review review = new Review();
        review.setBookId(testBook.getId());
    ...
    @Test
    public void postReviewEndpoint() throws Exception {
        Review review = new Review();
        review.setBookId(testBook.getId());
    ...
    @Test
    public void averageRatingIsCalculated() {
    ...
    // 10 ✅ Empty books list
    @Test
    public void getAllBooksReturnsEmptyWhenNoneExist() throws Exception {
        bookRepo.deleteAll();
        mockMvc.perform(get("/api/books"))
                .andExpect(status().isOk())
